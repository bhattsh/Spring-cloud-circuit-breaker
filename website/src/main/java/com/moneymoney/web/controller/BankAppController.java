...
public class BankAppController {
	...
	public String deposit(@ModelAttribute Transaction transaction, Model model) {
		...
		restTemplate.postForEntity("http://gateway-service/transaction/transactions", transaction, null);
...
//		System.out.println(restTemplate.getForEntity("http://localhost:8998/transactions", String.class));
	...
	public String transferMoney(@RequestParam int senderAccountNumber, @RequestParam int receiverAccountNumber,
	...
	public ModelAndView getStatement(@RequestParam("offset") int offset, @RequestParam("size") int size) {
		...
		CurrentDataSet currentDataSet = restTemplate.getForObject("http://gateway-service/transaction/transactions",
